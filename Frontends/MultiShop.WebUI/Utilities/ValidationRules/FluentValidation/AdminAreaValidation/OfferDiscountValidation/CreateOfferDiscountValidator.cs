...
namespace MultiShop.WebUI.Utilities.ValidationRules.FluentValidation.AdminAreaValidation.OfferDiscountValidation
{
    public class CreateOfferDiscountValidator : AbstractValidator<CreateOfferDiscountDto>
    {
        public CreateOfferDiscountValidator()
        {
            ...
            RuleFor(od => od.OfferDiscountSubImage).NotEmpty().WithMessage("Görsel Alanı Boş Olamaz!");
